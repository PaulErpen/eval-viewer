        ...
        for dataset in ["room", "stump", "truck"]:
            for technique in [
                ...
                if technique in ["default", "mcmc"]:
                    model_files.append(
                        ModelFile(
                            f"{data_dir}/models/{technique}/{technique}-{dataset}-{size}-3/{technique}-{dataset}-{size}-3_model.ply",
                    ...
                    model_files.append(
                        ModelFile(
                            f"{data_dir}/models/mini-splatting/mini_splatting-{dataset}-{size}-3/point_cloud/iteration_30000/point_cloud.ply",
                    ...
                    model_files.append(
                        ModelFile(
                            f"{data_dir}/models/eagles/eagles-{dataset}-{size}-3/point_cloud/iteration_30000/point_cloud.ply",
                    ...
                    model_files.append(
                        ModelFile(
                            f"{data_dir}/models/mip-splatting/mip_splatting-{dataset}-{size}-3/point_cloud/iteration_30000/point_cloud.ply",
                    ...
                    model_files.append(
                        ModelFile(
                            f"{data_dir}/models/gaussian-pro/gaussian_pro-{dataset}-{size}-3/point_cloud/iteration_30000/point_cloud.ply",
                    ...
                    model_files.append(
                        ModelFile(
                            f"{data_dir}/models/geogaussian/geo_gaussian-{dataset}-{size}-3/point_cloud/iteration_30000/point_cloud.ply",
